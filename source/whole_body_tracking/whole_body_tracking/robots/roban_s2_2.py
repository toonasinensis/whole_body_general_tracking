...
from whole_body_tracking.actuators.actuator_cfg import DelayedPDActuatorCfg_RobanS2, DelayedPDActuatorCfg_RobanS2_2
...
RobanS2_2_CYLINDER_CFG = ArticulationCfg(
    ...
    actuators={
        "motor": DelayedPDActuatorCfg_RobanS2_2(
            joint_names_expr=[
                "waist_yaw_joint",
                "leg_.*",
                "zarm_.*",
...
RobanS2_2_ACTION_SCALE = {}
for a in RobanS2_2_CYLINDER_CFG.actuators.values():
    ...
    for joint_name in candidate_joint_names:
        ...
        if e_val is None or e_rated_val is None or s_val in (None, 0):
            continue
        RobanS2_2_ACTION_SCALE[joint_name] = 0.25 * float(e_rated_val * 0.6) / float(s_val)
