"""Flat environment config for FSQ-Track on Roban S2.2."""
from isaaclab.utils import configclass

from isaaclab.managers import SceneEntityCfg

from whole_body_tracking.robots.roban_s2_2 import (
    PRESERVE_JOINT_ORDER_ASSET_CFG,
    RobanS2_2_ACTION_SCALE,
    RobanS2_2_CYLINDER_CFG,
)
from whole_body_tracking.tasks.fsqtrack.fsqtrack_env_cfg_roban import FsqtrackEnvCfg
from whole_body_tracking.tasks.fsqtrack.config.roban.agents.rsl_rl_ppo_cfg import LOW_FREQ_SCALE
