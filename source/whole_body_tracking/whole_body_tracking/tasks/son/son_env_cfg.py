...
from whole_body_tracking.tasks.son.mdp.terrain_rough import MY_ROUGH_TERRAINS_CFG
from whole_body_tracking.robots.kuavo_s52 import KUAVO_S52_PRESERVE_JOINT_ORDER_ASSET_CFG

from isaaclab.utils import configclass
from isaaclab.utils.noise import AdditiveUniformNoiseCfg as Unoise

import whole_body_tracking.tasks.son.mdp as mdp
...
@configclass
class CommandsCfg:
    """Command specifications for the SON MDP."""
...
@configclass
class ActionsCfg:
    """Action specifications for the SON MDP."""
...
class ObservationsCfg:
    """Observation specifications for the SON MDP."""
...
@configclass
class RewardsCfg:
    """Reward terms for the SON motion-tracking MDP."""
...
class TerminationsCfg:
    """Termination terms for the SON MDP."""
...
@configclass
class CurriculumCfg:
    """Curriculum terms for the SON MDP (unused for now)."""
    pass
...
#############################
@configclass
class SonEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the SON multi-motion tracking environment."""
