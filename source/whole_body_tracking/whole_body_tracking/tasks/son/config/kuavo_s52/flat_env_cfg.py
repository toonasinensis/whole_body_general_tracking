...
from whole_body_tracking.tasks.son.config.kuavo_s52.agents.rsl_rl_ppo_cfg import LOW_FREQ_SCALE
from whole_body_tracking.tasks.son.son_env_cfg import SonEnvCfg


from whole_body_tracking.robots.kuavo_s52 import KUAVO_S52_PRESERVE_JOINT_ORDER_ASSET_CFG
@configclass
class KuavoS52FlatEnvCfg(SonEnvCfg):
