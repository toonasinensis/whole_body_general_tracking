...
class MotionCommandS52(CommandTerm):
    cfg: MotionCommandCfgS52

    def __init__(self, cfg: MotionCommandCfgS52, env: ManagerBasedRLEnv):
    ...
    @property
    def body_pos_w(self) -> torch.Tensor:
        # this requires the order of body names in the motion buffer is the same as the order in the simulation environment
    ...
    def _adaptive_sampling(self, env_ids: Sequence[int]):
        ...
        # HOOK 
        # print("time_steps", self.time_steps[env_ids])
        # print("env_ids number", len(env_ids))
        # print("episode_failed", episode_failed)
        # print("self._env.max_episode_length: ", self._env.max_episode_length)
        # print("self._env.episode_length_buf: ", self._env.episode_length_buf)
        # HOOK
    ...
    def _update_command(self):
        ...
        # self.time_steps[:] = 0                                            # for test
        # self.out_time[:] = 0                                              # for test
        # env_ids = torch.where(self.out_time > self.cfg.end_hold_steps)[0] # for test
...
@configclass
class MotionCommandCfgS52(CommandTermCfg):
    """Configuration for the motion command."""

    class_type: type = MotionCommandS52
