...
from whole_body_tracking.tasks.tracking.mdp.terrain_rough import MY_ROUGH_TERRAINS_CFG
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        # terrain_generator=MY_ROUGH_TERRAINS_CFG,
...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfgS52(
        asset_name="robot",
...
@configclass
class TrackingEnvCfgS52(ManagerBasedRLEnvCfg):
