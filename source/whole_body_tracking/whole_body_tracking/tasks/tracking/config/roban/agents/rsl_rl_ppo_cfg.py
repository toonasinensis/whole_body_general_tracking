...
from whole_body_tracking.tasks.tracking.config.roban.flat_env_cfg import ROBAN_S22_MOTION_ANCHOR_BODY_NAME, ROBAN_S22_MOTION_BODY_NAMES

RobanS22_AMP_MOTION_DIR = os.path.normpath(
    os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../../../../../../data/Roban22_amp/Recovery/npz"))
)
...
@configclass
class RobanS22FlatFMPPORunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class RobanS22FlatAMPRunnerCfg(RobanS22FlatFMPPORunnerCfg):
    experiment_name = "roban22_amp"
        ...
        plugins=[
            {
                ...
                "amp_reward_coef": 0.1,
                "amp_motion_files": RobanS22_AMP_MOTION_DIR,
                "amp_task_reward_lerp": 0.75,
                "amp_discr_hidden_dims": [1024, 1024, 512, 256],
                "amp_replay_buffer_size": 200000,
                "amp_body_names": ROBAN_S22_MOTION_BODY_NAMES,
                "amp_anchor_name": ROBAN_S22_MOTION_ANCHOR_BODY_NAME,
            }
        ],
    )