...
from whole_body_tracking.tasks.sonic.mdp.terrain_rough import MY_ROUGH_TERRAINS_CFG
from whole_body_tracking.robots.kuavo_s52 import KUAVO_S52_PRESERVE_JOINT_ORDER_ASSET_CFG

from isaaclab.utils import configclass
from isaaclab.utils.noise import AdditiveUniformNoiseCfg as Unoise

import whole_body_tracking.tasks.sonic.mdp as mdp
...
class CommandsCfg:
    ...
    # Sonic uses its own motion command that outputs 10-frame sequences.
    motion = mdp.MotionCommandSonicCfg(
        asset_name="robot",
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Command window (10 frames of joint pos/vel)
...
@configclass
class RewardsCfg:
    """Reward terms for the Sonic motion-tracking MDP."""

    # motion_global_anchor_pos = RewTerm(
    #     func=mdp.motion_global_anchor_position_error_exp,
    #     weight=0.3,
    #     params={"command_name": "motion", "std": 0.3},
    # ) # NOTE this reward is not used in the SONIC task. shall we add it back?
    ...
    # joint limits
    joint_limit = RewTerm(
        # func=mdp.sonic_joint_limit_penalty,
...
class TerminationsCfg:
    """Termination terms for the Sonic MDP."""
...
class EventCfg:
    ...
    add_joint_default_pos = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": KUAVO_S52_PRESERVE_JOINT_ORDER_ASSET_CFG,
...
@configclass
class CurriculumCfg:
    """Curriculum terms for the MDP (unused for now)."""
    pass # NO curriculum terms for sonic task
...
#############################
@configclass
class SonicEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the Sonic motion-tracking environment."""
    ...
    def __post_init__(self):
        ...
        # general settings
        self.decimation = 4
        self.episode_length_s = 10.0 # The episode length is different from the beyondmimic style
        # simulation settings
        self.sim.dt = 0.005
