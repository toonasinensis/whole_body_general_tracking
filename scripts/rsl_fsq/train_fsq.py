...
parser.add_argument("--task", type=str, default="Fsqtrack-Flat-S52-v0", help="Name of the FSQ-Track task (Gym ID).")
...
import whole_body_tracking.tasks.fsqtrack.config.kuavo_s52  # noqa: F401
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.motion_path is not None:
        ...
        if hasattr(motion_cfg, "motion_file"):
            ...
            motion_cfg.dataset_dirs = [str(artifact_root)]
        else:
            raise ValueError(
                "commands.motion has neither 'motion_file' nor 'dataset_dirs'. "
                "Please check your command configuration."
            )
