...
def _collect_onnx_metadata(vec_env, base_env, policy, encoder_mode: str | None, fsq_sample_mode: str | None) -> dict:
    ...
    return {
        "encoder_mode": encoder_mode or "split",
        "fsq_sample_mode": fsq_sample_mode or "encode",
    ...
    if args_cli.export_onnx:
        ...
        onnx_path = export_grouped_motion_policy_as_onnx(
            ...
            metadata=_collect_onnx_metadata(
                env, env.unwrapped, policy, args_cli.encoder_mode, args_cli.fsq_sample_mode
            ),
        )
