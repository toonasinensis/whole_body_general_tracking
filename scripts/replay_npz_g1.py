...
# Pre-defined configs
##
from whole_body_tracking.tasks.tracking.mdp import MotionLoader, MotionCommandCfg
...
class ReplayMotionsSceneCfg(InteractiveSceneCfg):
    ...
    ground = TerrainImporterCfg(
        ...
        terrain_generator=STL_PLATFORM_TERRAINS_CFG,
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    motion_file = "/home/thl/wt_wbc/wbc_parkour/whole_body_tracking/data/tracking_npz_data"
    ...
    # 计算基于 motion id 的位置偏移（根据地形网格）
    # STL_PLATFORM_TERRAINS_CFG: num_rows=29, num_cols=1, size=(5.0, 5.0)
    # 假设每行沿 y 方向排列，行间距为地形高度/行数
    terrain_size_y = STL_PLATFORM_TERRAINS_CFG.size[1]  # 5.0
    # num_terrain_rows = STL_PLATFORM_TERRAINS_CFG.num_cols  # 29
