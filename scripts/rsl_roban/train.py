...
parser.add_argument("--task", type=str, default=None, help="Name of the task (Gymnasium env id).")
...
# fail fast with a clear message (Hydra decorator needs a task name)
if args_cli.task is None:
    raise SystemExit("Missing required argument: --task (Gymnasium env id, e.g. Tracking-Flat-RobanS2_2-v0)")
...
if __name__ == "__main__":
    ...
    # hydra_task_config injects the configs at runtime; suppress static type checking here.
