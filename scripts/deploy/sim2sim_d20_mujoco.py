...
from sim2sim_d20.mujoco_robot import D20_MJCF  # noqa: F401
...
from sim2sim_g1.observations import (
    ImuReader,
    TermMajorHistory,
    build_obs,
    print_imu_debug,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run D20 ONNX policy in MuJoCo.")
    ...
    parser.add_argument("--xml_path", default=str(D20_MJCF))
    ...
    parser.add_argument("--imu_quat_sensor", default="pelvis_quat", help="MuJoCo framequat sensor name.")
    parser.add_argument("--imu_gyro_sensor", default="angular_velocity", help="MuJoCo gyro sensor name.")
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Render a translucent D20 that follows the reference motion in the MuJoCo viewer.",
    )
    ...
    parser.add_argument("--reference_alpha", type=float, default=0.35, help="Transparency for the reference D20.")
    parser.add_argument(
...
def main() -> None:
    ...
    if meta.get("encoder_mode") not in (None, "robot", "encoder_g1", "g1", "encoder_d20", "d20"):
        print(
