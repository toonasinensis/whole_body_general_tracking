...
python scripts/g1_yang_general_tracking/train.py \
  --task=Tracking-Flat-G1-v0 \
  --num_envs=4096 \
  --registry_name=local \
  --motion_file=assets/g1_motions/221117 \
  --headless \
  --logger wandb --log_project_name general_tracking --run_name g1_yang_general_tracking_221117
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Path to a directory of tracking-format motion .npz files (overrides env config).",
)
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # override reference motion source from CLI (useful for local datasets)
